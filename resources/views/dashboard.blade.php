...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
	...
	<a href="\" class="rounded-full mb-3 mt-2 py-3 px-4 uppercase text-xs font-bold cursor-pointer tracking-wider text-pink-500 border-pink-500 border-2 hover:bg-pink-500 hover:text-white transition ease-out duration-500">Home</a>
</div>
            <button wire:click="openModal()" class="px-10 py-2 bg-blue-500 text-white my-5 mx-10 rounded-xl">Add</button>
                            ...
                            <tbody class="text-gray-600 text-sm font-light">
                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <span class="bg-purple-200 text-purple-600 py-1 px-3 rounded-full text-xs">{{$item->food}}</span>
                                    </td>
                                    <td class="py-3 px-6 text-center">
